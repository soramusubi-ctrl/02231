...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="relative bg-white/80 shadow-sm sticky top-0 z-50 print:hidden overflow-hidden border-b border-stone-100">
      {/* 背景画像 */}
      ...
      {/* コンテンツ */}
      <div className="relative z-10 max-w-2xl mx-auto px-4 py-3 flex items-center justify-between">
        {/* ロゴ・タイトル */}
        <button
          ...
          aria-label="ホームへ戻る"
        >
          <div className="bg-white/60 p-2 rounded-2xl backdrop-blur-md shadow-sm border border-stone-200/50 shrink-0">
            <svg
          ...
          <h1 className="text-base sm:text-lg font-bold tracking-wide text-stone-700 drop-shadow-sm leading-tight">
            おつかれさまです！<br className="sm:hidden" />
            <span className="text-green-700">ごはん、手伝います！</span>
          </h1>
        </button>
