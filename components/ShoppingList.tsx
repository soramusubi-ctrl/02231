    ...
    <div className="animate-fade-in-up">
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-2xl font-bold text-stone-700 flex items-center gap-2">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-8 h-8 text-pastel-blue">
              ...
              {items.map((item, index) => {
                ...
                return (
                  <div 
                    key={index} 
                    className={`
                      flex items-center gap-3 p-4 hover:bg-stone-50 transition-colors cursor-pointer group
                  ...
                  >
                    ...
                    `}>
                      {isChecked && (
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4 text-blue-900">
                          <path fillRule="evenodd" d="M19.916 4.626a.75.75 0 0 1 .208 1.04l-9 13.5a.75.75 0 0 1-1.154.114l-6-6a.75.75 0 0 1 1.06-1.06l5.353 5.353 8.493-12.739a.75.75 0 0 1 1.04-.208Z" clipRule="evenodd" />
                        </svg>
                      )}
                    </div>
                    
                    <span className={`flex-1 ${isChecked ? 'text-stone-400 line-through' : 'text-stone-700 font-medium'}`}>
                      {item}
                    </span>
